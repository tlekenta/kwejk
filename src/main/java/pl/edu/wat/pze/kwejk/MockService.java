...
public class MockService {
    ...
    @Getter
    private final Picture[] MOCK_PICTURES = {
    ...
    @Getter
    private final Article[]  MOCK_ARTICLES = {
            new Article((long) 1,
    ...
    public MockService() {
        MOCK_PICTURES[3].setArticle(MOCK_ARTICLES[0]);
        MOCK_PICTURES[4].setArticle(MOCK_ARTICLES[1]);
    }
}
